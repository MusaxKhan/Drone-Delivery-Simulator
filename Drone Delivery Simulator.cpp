...
int main()
{
	...
	char terrain[PatchRows][PatchCols] = {
		// Rows 0–2 (First 3 rows) - All 'C'
		{'C','C','C','C','C','C','C','C','C','C','C','C','C','C'},
		{'C','C','C','C','C','C','C','C','C','C','C','C','C','C'},
		{'C','C','C','C','C','C','C','C','C','C','C','C','C','C'},

		// Row 3 to 22 – Safe middle region, allow 'W' and '#'
		{'C','C','C','C','C','W','C','#','C','W','C','C','C','C'},
		{'C','C','C','C','C','C','W','C','W','C','C','C','C','C'},
		{'C','C','C','C','#','C','C','C','C','C','W','C','C','C'},
		{'C','C','#','C','C','W','C','C','W','C','C','C','C','C'},
		{'C','C','C','C','W','C','C','#','C','W','C','C','C','C'},
		{'C','C','C','#','C','C','#','C','C','C','C','W','C','C'},
		{'C','C','C','C','C','W','C','C','W','C','C','C','C','C'},
		{'C','C','#','C','W','C','#','C','C','C','W','C','C','C'},
		{'C','C','C','C','C','C','C','W','C','#','C','C','C','C'},
		{'C','C','W','C','#','C','W','C','C','C','C','W','C','C'},
		{'C','C','C','#','C','C','C','C','#','C','W','C','C','C'},
		{'C','C','#','C','C','#','C','W','C','C','C','C','C','C'},
		{'C','C','C','C','W','C','C','C','W','C','#','C','C','C'},
		{'C','C','C','#','C','W','C','C','C','C','C','W','C','C'},
		{'C','C','C','#','#','#','W','C','W','C','C','C','C','C'},
		{'C','C','W','#','C','#','#','#','C','C','W','C','C','C'},
		{'C','C','C','#','#','#','#','C','C','W','C','C','C','C'},
